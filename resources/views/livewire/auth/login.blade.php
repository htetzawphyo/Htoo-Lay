...
$login = function() {
    ...
    if(Auth::attempt($credentials)){
        ...
        return back()->with('incorrect-message', 'Email or Password Incorrect!');
    }
}
        ...
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
            ...
            <div class="w-2/4 max-md:w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    {{-- Error Message --}}
                    @if(session()->has('incorrect-message'))
                        <div class="mb-4 rounded-sm bg-red-500 px-6 py-2 text-base text-neutral-200 w-ful" role="alert">
                            {{ session('incorrect-message') }}
                        </div>
                    @endif
                    ...
                    <form class="space-y-4 md:space-y-6" wire:submit.prevent="login">
                        <div class="mb-4">
                            ...
                            <input wire:model="username" type="text" id="username" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter email" required="">
                        </div>
                        <div class="mb-4">
                            <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                            <input wire:model="password" type="password" id="password" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                        </div>
